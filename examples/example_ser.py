...
if solo_tree:
    ...
    ser.SER(dts[1], 0, X_target_005, y_target_005, original_ser=True)

    dts[2] = copy.deepcopy(dtree_or)
    ser.SER(dts[2], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red)

    dts[3] = copy.deepcopy(dtree_or)
    ser.SER(dts[3], 0, X_target_005, y_target_005, original_ser=False, no_ext_on_cl=True, cl_no_ext=cl_no_red)

    # no ext vars
    dts[4] = copy.deepcopy(dtree_or)
    ser.SER(dts[4], 0, X_target_005, y_target_005, original_ser=False, no_ext_on_cl=True, cl_no_ext=cl_no_red, ext_cond=True)
    dts[5] = copy.deepcopy(dtree_or)
    ser.SER(dts[5], 0, X_target_005, y_target_005, original_ser=False, no_ext_on_cl=True, cl_no_ext=cl_no_red, leaf_loss_quantify=True, leaf_loss_threshold=0.2, coeffs=coeffs, root_source_values=root_source_values, Nkmin=Nkmin)
    dts[6] = copy.deepcopy(dtree_or)
    ser.SER(dts[6], 0, X_target_005, y_target_005, original_ser=False, no_ext_on_cl=True, cl_no_ext=cl_no_red, ext_cond=True, leaf_loss_quantify=True, leaf_loss_threshold=0.9, coeffs=coeffs, root_source_values=root_source_values, Nkmin=Nkmin)

    # no red vars
    dts[7] = copy.deepcopy(dtree_or)
    ser.SER(dts[7], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red, ext_cond=True)
    dts[8] = copy.deepcopy(dtree_or)
    ser.SER(dts[8], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red, leaf_loss_quantify=True, leaf_loss_threshold=0.2, coeffs=coeffs, root_source_values=root_source_values, Nkmin=Nkmin)
    dts[9] = copy.deepcopy(dtree_or)
    ser.SER(dts[9], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red, ext_cond=True, leaf_loss_quantify=True, leaf_loss_threshold=0.9, coeffs=coeffs, root_source_values=root_source_values, Nkmin=Nkmin)

    dts[10] = copy.deepcopy(dtree_or)
    ser.SER(dts[10], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red, no_ext_on_cl=True, cl_no_ext=cl_no_red)
    dts[11] = copy.deepcopy(dtree_or)
    ser.SER(dts[11], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red, no_ext_on_cl=True, cl_no_ext=cl_no_red, ext_cond=True)

    dts[12] = copy.deepcopy(dtree_or)
    ser.SER(dts[12], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red, no_ext_on_cl=True, cl_no_ext=cl_no_red, ext_cond=True, leaf_loss_quantify=True, leaf_loss_threshold=0.5, coeffs=coeffs, root_source_values=root_source_values, Nkmin=Nkmin)
    dts[0] = copy.deepcopy(dtree_or)
    ser.SER(dts[0], 0, X_target_005, y_target_005, original_ser=False, no_red_on_cl=True, cl_no_red=cl_no_red, no_ext_on_cl=True, cl_no_ext=cl_no_red, ext_cond=True, leaf_loss_quantify=True, leaf_loss_threshold=0.9, coeffs=coeffs, root_source_values=root_source_values, Nkmin=Nkmin)
